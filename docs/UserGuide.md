...
3. [Features](#features)
    ...
    2. [Listing all game entries](#listing-all-game-entries--list)
    3. [Editing a game entry](#editing-a-game-entry--edit)
    4. [Deleting a game entry](#deleting-a-game-delete)
    5. [Finding game entries](#finding-game-entries-find)
...
<br>Numbers larger than one billion or smaller than negative one billion is not supported by **GameBook**.
</div>
